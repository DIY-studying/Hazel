...
namespace Hazel
{
		...
		:m_RenderID(0)
	{
		...
		if (isCompiled == GL_FALSE)
		{
			...
			HZ_CORE_ASSERT(false,"vertex shader complition fail.");
			return;
		}
		...
		if (isCompiled == GL_FALSE)
		{
			...
			HZ_CORE_ERROR("{0}", infoLog.data());
			HZ_CORE_ASSERT(false, "fragment shader complition fail.");
			return;
		}
	...
	void Shader::SetUniformMat4(const glm::mat4& matrix,const std::string& name)
	{
